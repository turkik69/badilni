...
async function accessToken(env){
  ...
  const now=Math.floor(Date.now()/1000), header={alg:'RS256',typ:'JWT'}, payload={iss:sa.client_email,scope:'https://www.googleapis.com/auth/userinfo.email https://www.googleapis.com/auth/firebase.database https://www.googleapis.com/auth/firebase.messaging',aud:'https://oauth2.googleapis.com/token',iat:now,exp:now+3600};
